...
fun StudentTwoScreen() {
    ...
    Column(
        ...
        Text(
            text = "Kirby Ian M. Narzoles", //change to your name
            fontFamily = jostBold,
            fontSize = 28.sp,
        ...
        Text(
            ...
            text = "I am a dedicated student from the University of Cabuyao, committed to continuous learning, personal growth, and achieving excellence in my chosen field.",
