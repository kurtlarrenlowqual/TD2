...
fun StudentFiveScreen() {
    ...
    Column(
        ...
        Image(
            painter = painterResource(id = R.drawable.student5), //change this to your own image filename
        ...
        Text(
            text = "Jay-Em G. Mejia", //change to your name
            fontFamily = jostBold,
            fontSize = 28.sp,
        ...
        Text(
            ...
            text = "I am a BS Information Technology student at the University of Cabuyao. I enjoy playing basketball and reading manga.",
