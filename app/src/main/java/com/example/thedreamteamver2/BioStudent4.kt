...
fun StudentFourScreen() {
    ...
    Column(
        ...
        Text(
            text = "I'm a 3rd year student of Bachelor of Science in Information Technology in University of Cabuyao. I love playing online games and playing volleyball.",
